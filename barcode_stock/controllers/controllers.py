...
class StockBarcodeController(http.Controller):
    ...
    @http.route('/smartbiz_stock/scan_from_main_menu', type='json', auth='user')
    ...
    @http.route('/smartbiz_stock/save_barcode_data', type='json', auth='user')
    ...
    @http.route('/smartbiz/open_view', type='json', auth='user')
    ...
    @http.route('/smartbiz_stock/get_barcode_data', type='json', auth='user')
    ...
    @http.route('/smartbiz_stock/get_specific_barcode_data', type='json', auth='user')
    ...
    @http.route('/smartbiz_stock/rid_of_message_demo_barcodes', type='json', auth='user')
    ...
    @http.route('/smartbiz_stock/print_inventory_commands', type='http', auth='user')
