...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    "description":"""
        ...
        Warehouse Product Quantity in SO App helps users to show product availability in sales order with location detailed quantity in warehouse. User can easily view product available quantity with detailed location as per warehouse wise in the sales order line.
