...
class TurnoverReport(models.Model):
    """Created for to select date, products, categories, companies and
    ...
    def _compute_name(self):
        for record in self:
            record.name = "Từ " + str(record.start_date) + " Đến " + str(record.end_date)
    ...
    def action_pdf_report_generate(self):
        ...
        return (self.env.ref(
            'turnover_report.inventory_turnover_report').
