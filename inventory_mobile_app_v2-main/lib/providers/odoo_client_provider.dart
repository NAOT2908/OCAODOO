...
import 'package:inven_barcode_app/commons/cookie.dart';
import 'package:inven_barcode_app/exceptions/odoo_exception.dart';
...
class OdooClient {
  ...
  OdooClient([OdooSession? sessionId, http.BaseClient? httpClient]) {
  ...
  Future<dynamic> callAPI(path, data) async {
  ...
  Future<OdooSession> authenticate(String login, String password) async {
    final params = {'db': dbName, 'login': login, 'password': password};
